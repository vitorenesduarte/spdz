...
import sdc.avoidingproblems.exception.InvalidPlayersException;
import sdc.avoidingproblems.circuit.Circuit;
import static sdc.avoidingproblems.circuit.ExecutionMode.DISTRIBUTED;
...
import static sdc.avoidingproblems.circuit.GateSemantic.PLUS;
...
import sdc.avoidingproblems.algebra.mac.ToBeMACChecked;
